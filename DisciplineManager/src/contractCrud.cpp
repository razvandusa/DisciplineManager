...
void ContractCrud::add_disciplina(int id, const Service &service) {
...
void ContractCrud::generate_contract(int number_to_generate, const Service &service) {
    ...
    const auto total = service.get_lista_discipline().size();
...
void ContractCrud::reload_contract(const std::vector<Disciplina>& lista_discipline) {
    clear_contract();
