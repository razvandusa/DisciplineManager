...
void UI::add_disciplina_UI() const {
...
void UI::remove_disciplina_UI() const {
    std::string id_string;
...
void UI::update_disciplina_UI() const {
    std::string id_string;
...
void UI::find_disciplina_UI() const {
    std::string id_string;
...
void UI::filtrare_discipline_UI() const {
    std::vector<Disciplina>& lista_discipline = service.get_lista_discipline();
...
void UI::sortare_discipline_UI() const {
...
void UI::export_contract_UI() const {
