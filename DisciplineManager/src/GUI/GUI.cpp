...
void GUI::init_GUI() {
    ...
    auto *disciplinaLayout = new QFormLayout();
    ...
    buttonLayout->addWidget(contract_CRUD_button);
    buttonLayout->addWidget(contract_read_only_button);
...
void GUI::init_connections() {
    ...
    QObject::connect(contract_CRUD_button, &QPushButton::clicked,[&]() {
    ...
    QObject::connect(contract_read_only_button, &QPushButton::clicked,[&]() {
        if (contract_window != nullptr) {
